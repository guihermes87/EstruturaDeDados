Conceitos
Raiz - nó ou nodo de uma (sub)arvore
Folha - nó ou nodo sem filhos
-Percurso
  -RED - Pré-fixado - PESQUISA
  -LERD - in-fixado - EXIBIÇÃO
  -LEDR - pós-fixado - DESTRUIÇÃO/APAGAR ÁRVORE

  Nó árvore = possui filho direita ou esquerda.
